...
VALUES
('Cap', 22.90, 'LaserCap.jpeg', 100, 'Caps for every style and season', 'price_1M7OkEBIwndE5957BA27qJ0W', 1, 1, 1, 1, 1, 1),
('Shirt', 35.00, 'LaserShirt.jpeg', 50, 'Heartbreaker shirts', 'price_1M7OmZBIwndE5957EFWdmtdS', 1, 0, 1, 0, 1, 1),
('Socks', 11.50, 'LaserSocks.jpeg', 200, 'Keep those toesies safe', 'price_1M7OojBIwndE5957Sqtlqa58', 1, 0, 1, 0, 0, 0),
('Hoodie', 99.00, 'LaserHoodie.jpeg', 10, 'Only for the cool kids', 'price_1M7OqwBIwndE5957FXt7yuZV', 1, 0, 1, 0, 0, 1),
('Shorts', 32.00, 'LaserShorts.jpeg', 80, 'For your day-to-day wear', 'price_1M7OsSBIwndE5957gBgfF5Eb', 1, 1, 1, 0, 0, 1),
('Hat', 28.80, 'LaserCord.jpeg', 500, 'Style yourself up with this sweet fabric hat', 'price_1M7OuzBIwndE5957wTZYLx3J', 1, 0, 1, 0, 0, 0),
('Hoodie', 80.80, 'HumanaHoodieSet.jpeg', 50, 'Feel like an absolute beast in this set', 'price_1M7P4aBIwndE5957YszgSQPw', 2, 0, 0, 1, 1, 0),
('Scarf', 29.50, 'CrochetScarf.jpeg', 100, 'Scarf to keep you warm', 'price_1M44dEBIwndE5957Cait0D15', 2, 0, 1, 1, 1, 1),
...
('Coffee', 5.99, 'coffee.jpg', 100, 'Coffee brewed and served fresh in-store', 'price_1M44bEBIwndE5957lW1avj2o', 3, 0, 0, 1, 1, 1),
('Latte', 7.99, 'SyraLatte.jpeg', 80, 'Latte, batte, schmatte', 'price_1M7P9OBIwndE59574ydbAIho', 3, 0, 0, 1, 1, 1),
('Apples', 2.99, 'apples.jpeg', 220, 'You know what they say, an apple a day keeps the bad juju away', 'price_1M7PBoBIwndE5957r1gzyYzy', 4, 0, 0, 1, 1, 1),
('Tomatoes', 5.00, 'tomatoes.jpeg', 300, 'Red red red tomatoes', 'price_1M7PGlBIwndE5957zWTPhXbj', 4, 0, 0, 1, 1, 1),
('Oranges', 3.20, 'oranges.jpeg', 180, 'Get your dose of vitamin C', 'price_1M7PE6BIwndE5957hUV15Jmt', 4, 0, 0, 0, 1, 1),
('Camera', 399.99, 'Camera.jpeg', 50, 'The best camera around, we only sell authentic luxe cameras', 'price_1M49HEBIwndE59571OqKQqvk', 5, 0, 1, 0, 0, 0),
('Belt', 500.99, 'LVbelt.jpeg', 30, 'LV belt, if you have money coming out of your ears #justsaying', 'price_1M44eiBIwndE5957FrOiJum7', 5, 0, 1, 0, 0, 0),
('Book', 1290.90, 'AntiqueBook.jpeg', 1, 'Absolutely one of a kind, rare, antique book dating back from the 1800s', 'price_1M44eiBIwndE5957FrOiJum7', 5, 0, 1, 0, 0, 0),
('Vase', 250.00, 'Vase.jpeg', 10, 'Handblown and handcrafted to exquisite perfection', 'price_1M7QCCBIwndE5957i3qBTcW8', 5, 0, 1, 0, 0, 0);
