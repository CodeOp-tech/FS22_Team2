...
VALUES
('Laser', 'Carrer del Dr. Dou, 2, 08001 Barcelona', 'We try to convey with each collection all these local concepts
                that may seem invisible to any citizen.', 'https://cdn.shopify.com/s/files/1/0449/4613/files/5_064da9be-c43a-48f5-9a11-f175a1e46095_grande.JPG?v=1552569309', 'https://laser.com', '12345678', 'laser@laser.com', 1, 1, 1, 0, 0, 41.38228037671287, 2.1693529361821065),
('Humana', 'C/ de Mallorca, 592, 08026 Barcelona','Improve the living conditions of the most disadvantaged
