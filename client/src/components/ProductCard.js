...
function ProductCard(props) {
  ...
  function showPopup(id) {
    // product_id from (props.product.product_id) passed to getProductReviewsCb function below
    setButtonPopup(true);
    ...
    >
      ...
      <div className="image">
        <Card.Img
          ...
          style={{ borderRadius: "30px", marginLeft: "9px", padding: "10px" }}
          src={product.url}
        />
      ...
      <div className="checkimgs">
        ...
        >
          <img
            ...
            src={
              product.recycled === 1
                ? "https://img.icons8.com/bubbles/100/null/recycle-sign.png"
                : " "
            }
          />
        </OverlayTrigger>
        ...
        >
          <img
            ...
            src={
              product.no_fridge === 1
                ? "https://img.icons8.com/bubbles/100/null/greenhouse-effect.png"
                : ""
            }
          />
        </OverlayTrigger>
        ...
        >
          <img
            style={{ width: "70px" }}
            src={
              product.fair_trade === 1
                ? "https://img.icons8.com/bubbles/100/000000/certificate.png"
                : ""
            }
          />
        </OverlayTrigger>
        ...
        >
          <img
            ...
            src={
              product.local === 1
                ? "https://img.icons8.com/bubbles/100/null/shop-local--v1.png"
                : ""
            }
          />
        </OverlayTrigger>
        ...
        >
          <img
            ...
            src={
              product.organic === 1
                ? "https://img.icons8.com/bubbles/100/000000/sprout.png"
                : ""
            }
          />
        </OverlayTrigger>
      </div>
      <Card.Text className="shopText">
        <a onClick={() => navigateShop(product.shop_id)}>
          from{" "}
          <i className="shopname">
            {(product && product.shop_name) ||
              (shopProfile && shopProfile.shop_name)}
          </i>
        </a>{" "}
        <br></br>
        <h5 style={{ marginTop: "15px" }}>{product.product_description}</h5>
      </Card.Text>
      <Card.Text className="shopText">
        <i>{totalProductPoints} point(s) rewarded</i>
        <br></br>
            ...
            <Col sm="6">
              <Button
                ...
                style={{
                  margin: "5px",
                  fontWeight: "900",
                  backgroundColor: "rgba(101, 212, 172, 0.884",
                }}
