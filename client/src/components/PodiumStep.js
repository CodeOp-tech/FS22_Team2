...
export default function PodiumStep({ podium, winner }) {
  ...
  return (
    <div className="IntroForWinners">
      {/* <h2>New winners every month!</h2>
      <span>
        Earn points and redeem prizes for shopping sustainably! Check out our
        top sustainable shoppers.
      </span> */}
